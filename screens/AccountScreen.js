        ...
        >
          <ScrollView>
            ...
            <Text>
              ...
              accessible at Sheltie unless otherwise defined in this Privacy
              Policy. {"\n"}
            ...
            <Text>
              ...
              property rights related to it, still belong to Cameron Hammel.
              Cameron Hammel is committed to ensuring that the app is as useful
              ...
              you’re paying for. The Sheltie app stores and processes personal
              ...
              security features and it could mean that the Sheltie app won’t
              work properly or at all. The app does use third party services
              that declare their own Terms and Conditions. You should be aware
              that there are certain things that Cameron Hammel will not take
              ...
              Wi-Fi, or provided by your mobile network provider, but Cameron
              Hammel cannot take responsibility for the app not working at full
              functionality if you don’t have access to Wi-Fi, and you don’t
              have any of your data allowance left. If you’re using the app
              outside of an area with Wi-Fi, you should remember that your terms
              of the agreement with your mobile network provider will still
              ...
              received permission from the bill payer for using the app. Along
              the same lines, Cameron Hammel cannot always take responsibility
              ...
              turn it on to avail the Service, Cameron Hammel cannot accept
              responsibility. With respect to Cameron Hammel’s responsibility
              ...
              app. Cameron Hammel does not promise that it will always update
